package de.adorsys.xs2a.adapter.impl.adapter.link.bg;

import de.adorsys.xs2a.adapter.impl.adapter.link.bg.template.LinksTemplate;
...
import static de.adorsys.xs2a.adapter.impl.adapter.link.bg.template.LinksTemplate.*;
