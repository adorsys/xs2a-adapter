...
public enum BalanceTypeTO {
  ...
  @JsonCreator
  public static BalanceTypeTO fromValue(String text) {
    for (BalanceTypeTO b : BalanceTypeTO.values()) {
