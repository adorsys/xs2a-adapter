...
public class PaymentInitiationSctWithStatusResponse {
  ...
  private AmountTO instructedAmount = null;
  ...
  private AddressTO creditorAddress = null;
...
@Size(max=35) 
  ...
  public PaymentInitiationSctWithStatusResponse debtorAccount(AccountReferenceTO debtorAccount) {
  ...
  **/
  ...
  public PaymentInitiationSctWithStatusResponse instructedAmount(AmountTO instructedAmount) {
  ...
  **/
  ...
  public PaymentInitiationSctWithStatusResponse creditorAccount(AccountReferenceTO creditorAccount) {
...
@Size(max=70) 
  ...
  public PaymentInitiationSctWithStatusResponse creditorAddress(AddressTO creditorAddress) {
