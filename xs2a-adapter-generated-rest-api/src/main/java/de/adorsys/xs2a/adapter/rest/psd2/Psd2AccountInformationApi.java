...
public interface Psd2AccountInformationApi {
    ...
    ResponseEntity<ReadAccountBalanceResponseTO> getBalances(
    ...
    @RequestMapping(
        value = "/accounts/{account-id}/transactions/{transactionId}",
        method = RequestMethod.GET
    )
    ResponseEntity<TransactionDetailsResponseTO> getTransactionDetails(
        @PathVariable("account-id") String accountId,
    ...
    ResponseEntity<CardAccountListTO> getCardAccountList(
        @RequestParam Map<String, String> queryParameters, @RequestHeader Map<String, String> headers)
        throws IOException;
    ...
    ResponseEntity<ConsentsResponseTO> createConsent(
        @RequestParam Map<String, String> queryParameters, @RequestHeader Map<String, String> headers,
        @RequestBody ConsentsTO body) throws IOException;
    ...
    ResponseEntity<UpdateAuthorisationResponseTO> updateConsentsPsuData(
        @PathVariable("consentId") String consentId,
        @PathVariable("authorisationId") String authorisationId,
        @RequestParam Map<String, String> queryParameters, @RequestHeader Map<String, String> headers,
        @RequestBody UpdateAuthorisationTO body) throws IOException;
