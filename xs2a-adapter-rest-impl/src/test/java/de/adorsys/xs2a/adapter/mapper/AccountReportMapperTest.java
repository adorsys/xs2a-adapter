...
public class AccountReportMapperTest {
    private static final Transactions BOOKED = TransactionsMapperTest.buildTransactions();
    private static final Transactions PENDING = TransactionsMapperTest.buildTransactions();
