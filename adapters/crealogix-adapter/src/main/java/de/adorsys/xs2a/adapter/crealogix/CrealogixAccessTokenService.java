...
public class CrealogixAccessTokenService implements AccessTokenService {
    private static final Logger logger = LoggerFactory.getLogger(CrealogixAccessTokenService.class);
    ...
    private static CrealogixAccessTokenService instance;
    ...
    private CrealogixAccessTokenService() {
    ...
    public static synchronized CrealogixAccessTokenService getInstance() {
        if (instance == null) {
            instance = new CrealogixAccessTokenService();
        }
        return instance;
    }
