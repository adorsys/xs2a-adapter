...
class SpardaAccountInformationServiceTest {
    ...
    void getTransactionList() {
        ...
        when(httpClient.send(any(), any()))
            .thenReturn(new Response<>(-1, new SpardaTransactionResponse200Json(), ResponseHeaders.emptyResponseHeaders()));
    ...
    void getTransactionDetails() {
        when(httpClient.get(anyString()))
            .thenReturn(new RequestBuilderImpl(httpClient, "GET", URI));
        when(httpClient.send(any(), any()))
            .thenReturn(new Response<>(-1, new SpardaOK200TransactionDetails(), ResponseHeaders.emptyResponseHeaders()));
