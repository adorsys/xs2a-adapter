...
class SantanderAccountInformationServiceTest {
    ...
    void getTransactionList() {
        ...
        when(httpClient.send(any(), any()))
            .thenReturn(new Response<>(-1, new SantanderTransactionResponse200Json(), ResponseHeaders.emptyResponseHeaders()));
    ...
    void getTransactionDetails() {
        when(httpClient.get(anyString()))
            .thenReturn(new RequestBuilderImpl(httpClient, "GET", URI));
        when(httpClient.send(any(), any()))
            .thenReturn(new Response<>(-1, new SantanderOK200TransactionDetails(), ResponseHeaders.emptyResponseHeaders()));
