...
class SparkasseAccountInformationServiceTest {
    ...
    void getTransactionList() {
        ...
        when(httpClient.send(any(), any()))
            .thenReturn(new Response<>(-1, new SparkasseTransactionResponse200Json(), ResponseHeaders.emptyResponseHeaders()));
    ...
    void getTransactionDetails() {
        when(httpClient.get(anyString()))
            .thenReturn(new RequestBuilderImpl(httpClient, "GET", URI));
        when(httpClient.send(any(), any()))
            .thenReturn(new Response<>(-1, new SparkasseOK200TransactionDetails(), ResponseHeaders.emptyResponseHeaders()));
