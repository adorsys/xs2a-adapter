...
public class DeutscheBankAdapterManager implements AdapterManager {
    ...
    public ConsentService getConsentService() {
        if (consentService == null) {
            consentService = new DeutscheBankConsentService();
        }
    ...
    public PaymentService getPaymentService() {
        if (paymentService == null) {
            paymentService = new DeutscheBankPaymentService();
        }
