...
import static de.adorsys.xs2a.gateway.mapper.ExchangeRateMapperTest.buildExchangeRate;
...
public class TransactionsMapperTest {
    ...
    private static final ExchangeRate EXCHANGE_RATE = buildExchangeRate();
    ...
    private static final AccountReference CREDITOR_ACCOUNT = buildAccountReference();
    private static final String ULTIMATE_CREDITOR = "ultimateCreditor";
    private static final String DEBTOR_NAME = "debtorName";
    private static final AccountReference DEBTOR_ACCOUNT = buildAccountReference();
