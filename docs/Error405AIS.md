...
**code** | **String** |  | 
**additionalErrors** | [**List&lt;Error405AISAdditionalErrors&gt;**](Error405AISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional]
