...
------------- | ------------- | -------------
[**createSigningBasket**](SigningBasketsSbsApi.md#createSigningBasket) | **POST** /v1/signing-baskets | Create a signing basket resource
[**deleteSigningBasket**](SigningBasketsSbsApi.md#deleteSigningBasket) | **DELETE** /v1/signing-baskets/{basketId} | Delete the signing basket
[**getSigningBasket**](SigningBasketsSbsApi.md#getSigningBasket) | **GET** /v1/signing-baskets/{basketId} | Return the content of an signing basket object
[**getSigningBasketAuthorisation**](SigningBasketsSbsApi.md#getSigningBasketAuthorisation) | **GET** /v1/signing-baskets/{basketId}/authorisations | Get signing basket authorisation sub-resources request
[**getSigningBasketScaStatus**](SigningBasketsSbsApi.md#getSigningBasketScaStatus) | **GET** /v1/signing-baskets/{basketId}/authorisations/{authorisationId} | Read the SCA status of the signing basket authorisation
[**getSigningBasketStatus**](SigningBasketsSbsApi.md#getSigningBasketStatus) | **GET** /v1/signing-baskets/{basketId}/status | Read the status of the signing basket
[**startSigningBasketAuthorisation**](SigningBasketsSbsApi.md#startSigningBasketAuthorisation) | **POST** /v1/signing-baskets/{basketId}/authorisations | Start the authorisation process for a signing basket
[**updateSigningBasketPsuData**](SigningBasketsSbsApi.md#updateSigningBasketPsuData) | **PUT** /v1/signing-baskets/{basketId}/authorisations/{authorisationId} | Update PSU data for signing basket
...
//import de.adorsys.psd2.client.api.SigningBasketsSbsApi;

ApiClient defaultClient = Configuration.getDefaultApiClient();


SigningBasketsSbsApi apiInstance = new SigningBasketsSbsApi();
...
try {
    ...
    System.err.println("Exception when calling SigningBasketsSbsApi#createSigningBasket");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling SigningBasketsSbsApi#deleteSigningBasket");
    e.printStackTrace();
}
```
...
Return the content of an signing basket object
...
try {
    ...
    System.err.println("Exception when calling SigningBasketsSbsApi#getSigningBasket");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling SigningBasketsSbsApi#getSigningBasketAuthorisation");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling SigningBasketsSbsApi#getSigningBasketScaStatus");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling SigningBasketsSbsApi#getSigningBasketStatus");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling SigningBasketsSbsApi#startSigningBasketAuthorisation");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling SigningBasketsSbsApi#updateSigningBasketPsuData");
    e.printStackTrace();
}
```
