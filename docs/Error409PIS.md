...
**code** | **String** |  | 
**additionalErrors** | [**List&lt;Error409PISAdditionalErrors&gt;**](Error409PISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional]
