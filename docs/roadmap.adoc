...
a| * Implement adapter for Crealogix (DKB)

* Test successfully DKB for AIS, PIS
...
* Connect and test Hamburg Commercial Bank AG for AIS (dummy call)

* Connect and test Hamburg AAreal Bank AG for AIS (dummy call)

* Implement adapter for Oldenburgische Landesbank
...
a| * Test DAB for AIS (with the real account)

* Test Targobank (Bankverlag) fro AIS, PIS (with the real account)

* Test successfully PIS for Commerzbank, Unicredit

* Implement adapter for Societe Generale S.A

* Connect and test Societe Generale S.A for AIS (dummy call)

* Add WireMock mode other banks

* Implement automated update for CSV file in the Registry Manager
...
a| * Connect and test Societe Generale S.A for AIS (with the real account)
