...
**code** | **String** |  | 
**additionalErrors** | [**List&lt;Error405PISAdditionalErrors&gt;**](Error405PISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional]
