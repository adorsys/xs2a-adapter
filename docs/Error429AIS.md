...
**code** | **String** |  | 
**additionalErrors** | [**List&lt;Error429AISAdditionalErrors&gt;**](Error429AISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional]
