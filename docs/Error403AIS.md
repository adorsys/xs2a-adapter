...
**code** | **String** |  | 
**additionalErrors** | [**List&lt;Error403AISAdditionalErrors&gt;**](Error403AISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional]
