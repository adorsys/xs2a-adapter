...
**code** | **String** |  | 
**additionalErrors** | [**List&lt;Error409AISAdditionalErrors&gt;**](Error409AISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional]
