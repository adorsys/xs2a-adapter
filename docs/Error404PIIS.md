...
**code** | **String** |  | 
**additionalErrors** | [**List&lt;Error404PIISAdditionalErrors&gt;**](Error404PIISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated  |  [optional]
