 ...
 *  - 'rejected': The consent data have been rejected
 * e.g. since no successful authorisation has taken place.
 ...
 * by applying the DELETE method to the consent resource. The ASPSP might add further codes.
 * These codes then shall be contained in the ASPSP's documentation of the XS2A interface
