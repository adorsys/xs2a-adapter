...
public class ResponseHeaders {
    ...
    public static final String X_ASPSP_CHANGES_DETECTED = "X-ASPSP-CHANGES-DETECTED";
    ...
    static {
        ...
        headerNamesLowerCased.put(X_ASPSP_CHANGES_DETECTED.toLowerCase(), X_ASPSP_CHANGES_DETECTED);
    }
